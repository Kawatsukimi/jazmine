...
local autoblockEnabled = true  -- Controlled by your launcher
...
local function faceTarget(targetRoot)
    ...
    -- Camera: Keep your vertical angle
...
print("Autoblock loaded successfully (GUI disabled)")
